...
class AgentPolicyTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        model = AgentPolicy
        fields = ("name", "orb_id", "extra_tags", "description", "type", "interval", "timeout", "hostnames" )
        default_columns = ("name", "orb_id", "extra_tags", "description", "type", "interval", "timeout", "hostnames")

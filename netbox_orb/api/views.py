...
from .. import models
from .serializers import AgentSerializer, AgentGroupSerializer, AgentPolicySerializer, PolicyCloudProberSerializer, SinkSerializer, DatasetSerializer
...
class AgentPolicyViewSet(NetBoxModelViewSet):
    queryset = models.AgentPolicy.objects.prefetch_related('tags')

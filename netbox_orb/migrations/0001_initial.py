# Generated by Django 4.0.7 on 2022-09-29 16:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, unique=True)),
                ('orb_id', models.UUIDField(blank=True, null=True)),
                ('agent_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netbox_orb.agentgroup')),
                ('policy_cloud_prober', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netbox_orb.policycloudprober')),
                ('sink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='netbox_orb.sink')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
                'ordering': ('name',),

# Generated by Django 4.0.7 on 2022-09-28 21:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostnames', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), null=True, size=None)),
                ('agent_policy_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='netbox_orb.agentpolicy')),
                ('device_ids', models.ManyToManyField(to='dcim.device')),
                ('site_ids', models.ManyToManyField(to='dcim.site')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
                ('vm_ids', models.ManyToManyField(to='virtualization.virtualmachine')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_policy_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='netbox_orb.agentpolicy')),
                ('sink_ids', models.ManyToManyField(to='netbox_orb.sink')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, unique=True)),
                ('orb_id', models.UUIDField(null=True)),
                ('extra_tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), blank=True, null=True, size=None)),
